    ...
    <div className="container mx-auto px-4 py-8">
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <label htmlFor="price" className="block mb-2 text-gray-300">Ticket Price (ETH)</label>
            <div className="relative">
              <input
                type="number"
                id="price"
          ...
          <motion.button 
            type="submit" 
            className="w-full gradient-button px-4 py-3 rounded-lg text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            variants={itemVariants}
